...
import static com.fshows.proxy.sdk.SDKConstants.*;

import static com.fshows.proxy.sdk.SDKUtil.isEmpty;
...
//			LogUtil.writeErrorLog("InitCert Error File Not Found", e);
	...
	private static KeyStore getKeyInfo(String pfxkeyfile, String keypwd,
		...
		try {
			...
			System.out.println("=====load key info success=====");
			return ks;
		} catch (Exception e) {
